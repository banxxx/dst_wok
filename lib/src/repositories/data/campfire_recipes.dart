...
const campfireRecipes = [
  ...
  CampfireRecipe(
    ...
    desc:
        ...
        '• 会为沃拓克斯额外恢复 13.75 点饥饿(沃拓克斯只能从普通食物中回复一半的饱食度)',
    sideEffect: '',
    condition: '',
    notContain: '',
    cookbook: [],
  ...
  CampfireRecipe(
    ...
    notContain: '',
    cookbook: [],
    tips: [GameAssets.berrybushJuicy],
  ),
  CampfireRecipe(
  ...
  CampfireRecipe(
    ...
    freshness: '10',
    desc:
        '• 在火源[img:campfire]上烹饪蓝蘑菇[img:blue_cap]，就会变成熟蓝蘑菇[img:blue_cap_cooked_64]',
    sideEffect: '',
    condition: '',
    notContain: '',
    cookbook: [],
  ...
  CampfireRecipe(
    ...
    notContain: '',
    cookbook: [],
    tips: [GameAssets.oceanWobsterden],
  ),
  CampfireRecipe(
    id: 'trunk_cooked',
    name: '象鼻排',
  ...
  CampfireRecipe(
    ...
    notContain: '',
    cookbook: [],
    tips: [GameAssets.ancienttreeNightvision],
  ),
];
